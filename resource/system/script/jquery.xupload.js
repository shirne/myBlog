...
(function($){
	$.fn.upload = function(options) {
		...
		return new $.xupload(this, options);
	};
	
	$.xupload = function(element, options) {
		/** Fix scope problems */
		var self = this;
		...
		//container
		var container=$('<div></div>').appendTo(document.body).css({
			position: 'absolute',
		...
		/*Be sure the container is above the button*/
